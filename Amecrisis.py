...
eur_inr = yf.download("USDINR=X", start="2006-01-01", end="2024-05-11")
...
plt.plot(eur_inr.index, eur_inr['Close'], label='USD/INR')
...
plt.title('USD/INR Exchange Rate (2006-2024)')
plt.xlabel('Date')
...
print(f"The date with the maximum exchange rate is: {max_date}")
print(f"The date with the minimum exchange rate is: {min_date}")
